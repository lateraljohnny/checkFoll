...
-- If you wish to check who unfollowed you, you need 2 instances of your following list (Before and After) from different dates. Ex: 'following.html' from Monday and 'following.html' from Friday but rename it to 'following2.html'
...
3. Run this code in the brackets:
